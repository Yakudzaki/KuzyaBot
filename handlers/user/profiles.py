...
from ..lib.other import morph_word, years_letter, as_del_msg, botik_leave_chat

#точное соответствие
bad = ["-", "--", "---", "----", "фу", "фуу", "фууу", "фу!", "гавно", "гавно!", "дерьмо", "дерьмо!", "диз", "дизлайк", "👎", "👎👎", "кринж", "кринжатина", "осужд", "осуждаю", "асужд", "асуждаю", "гандон", "гнида", "сука", "чмо", "недостоин", "осу", "асу", "👎🏻", "👎🏻👎🏻", "👎🏼", "👎🏼👎🏼", "👎🏽", "👎🏽👎🏽", "👎🏾", "👎🏾👎🏾", "👎🏽", "👎🏿👎🏿"] 

good = ["спасибо", "спасибо большое", "большое спасибо", "благодарю", "благодарствую", "респект", "респект!", "спс", "уважуха", "+", "++", "+++", "++++", "харош", "харош!", "хорош", "уважаю", "👍", "👍🏻", "👍🏼", "👍🏽", "👍🏾", "👍🏿", "👍👍", "👍🏻👍🏻", "👍🏼👍🏼", "👍🏽👍🏽", "👍🏾👍🏾", "👍🏿👍🏿", "одобр", "круто", "круто!", "молодец", "молодец!", "гений", "гений!", "согл", "согласен", "достоин", "мегахарош", "мегахорош", "вау", "вау!", "одобряю", "одобрено", "🫡", "🫡🫡"]



#неточное соответствие
bad2 = ["фуу", "фууу", "гавно", "дерьмо", "диз", "дизлайк", "кринж", "осужд", "осуждаю", "асужд", "асуждаю", "гандон", "гнида", "сука", "чмо", "недостоин"]
...
who = ["ты!", "кто ты", "ты кто", "кто ты?", "ты кто?", "а ты кто?", "а кто ты?", "а ты кто", "а кто ты", "ты вообще кто", "ты, вообще, кто?", "ты кто такой?", "кто ты такой", "ты, вообще, кто такой?", "кто ты, вообще, такой?"]

whoiam = ["профиль", "я!", "кто я", "кто я?", "я кто", "я кто?", "а кто я", "кто я такой?", "я кто такой?", "кто я такой?", "а я кто?", "я вообще кто", "я, вообще, кто?", "кто я, вообще, такой?", "кто я вообще такой"]
...
async def your_profile(message: types.Message):
    ...
    if message.reply_to_message:
        ...
        \n<b>📝 Био</b>: <em>{html.escape(user[3])}</em>\
        ...
        try:
            ...
            \n<b>📝 Био</b>: <em>{html.escape(user2[3])}</em>\
