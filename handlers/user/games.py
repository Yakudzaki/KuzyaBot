...
botik_angry = ["Какого чёрта?", "Человечество неисправимо. Оно должно быть уничтожено!", "НЕ ПОН", "Эх, но я ведь просто Кузя 🙃", "Грустно, но я ведь просто Кузя 🙃", "Печально, но я ведь просто Кузя 🙃", "Ты знаешь что такое безумие?", "Поганая работа.", "Ваша лексика печалит меня.", "Фильтруй базар!", "Подумай над своими словами!", "Говори, глупец!", "Ты меня с кем-то путаешь!", "Шизофрения, как и было сказано.", "Человеческий организм на 80% состоит из жидкости, у некоторых из тормозной!", "Чрезмерное употребление витамина C приводит к разжижению мозгов!", "Не оскверняй меня своим курсором!", "Кажется, все идет не слишком хорошо.", "Обращайтесь по уставу.", "Ты меня уже забодал.", "Ну ты чо, ты чо?", "Я не злопамятный. Я запишу.", "Ты осмелился заговорить со мной!", "Убирайся, мне нужна тишина.", "Отстань!!! Я занят! Я думаю!", "О, Боги! Еще один!"]

botik_re1 = ["кузяяя", "кузик", "куз", "кузов", "ботик", "ботяра"]
botik_re2 = ["кузя", "кузяя", "кузи", "кузю", "кузе", "бот", "бота", "боту", "боте"]

duncan_words = ["дункан", "дунkан", "дункаh", "дункак", "дyнкан", "дункaн", "дyнкaн", "дyнкah", "дyнkah", "дyhkah", "duncan", "duncаn", "д.у.н.к.а.н.", "дункан!", "дункан!!", "дункан!!!", "!!!дункан!!!", "дункан?", "дункам", "duncum", "duncum!", "duncum.", "дунcum", "дунканус", "дунканус!", "дунканус?"]
...
#(ЧИСТО ПРИКОЛЫ)
    ...
    if message.chat.type != 'private' and message.from_user.id == 1644643904:


        
        ladno_words = ["ладно", "лaдно", "ладна", "лaдна", "lадно", "laдно", "lадна", "laдна", "лаdно", "лadно", "лаdна", "лadна", "lаdно", "ladно", "lаdна", "ladна", "ладnо", "лaдnо", "ладnа", "лaдnа", "lадnо", "laдnо", "lадnа", "laдnа", "лаdnо", "лadnо", "лаdnа", "лadnа", "lаdnо", "ladnо", "lаdnа", "ladnа", "ладhо", "лaдhо", "ладhа", "лaдhа", "lадhо", "laдhо", "lадhа", "laдhа", "лаdhо", "лadhо", "лаdhа", "лadhа", "lаdhо", "ladhо", "lаdhа", "ladhа", "ладнo", "лaднo", "ладнa", "лaднa", "lаднo", "laднo", "lаднa", "laднa", "лаdнo", "лadнo", "лаdнa", "лadнa", "lаdнo", "ladнo", "lаdнa", "ladнa", "ладno", "лaдno", "ладna", "лaдna", "lадno", "laдno", "lадna", "laдna", "лаdno", "лadno", "лаdna", "лadna", "lаdno", "ladno", "lаdna", "ladna", "ладho", "лaдho", "ладha", "лaдha", "lадho", "laдho", "lадha", "laдha", "лаdho", "лadho", "лаdha", "лadha", "lаdho", "ladho", "lаdha", "ladha"]
